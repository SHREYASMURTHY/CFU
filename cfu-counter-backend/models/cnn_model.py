...
class VanillaDeepCNN(nn.Module):
    ...
    """
    def __init__(self, in_channels=3, num_conv_blocks=8, base_filters=32, 
...
class CNNModel:
    ...
    def predict(self, image: np.ndarray) -> Dict:
        ...
        """
        # Bypass tiled inference as requested to test raw CNN performance
        # if h > train_h * 1.5 or w > train_w * 1.5:
        #     logger.info(f"Image {(w, h)} is large. Using CNN Tiled Inference.")
        #     return self.predict_tiled(image)
